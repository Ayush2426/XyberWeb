...
// Specific Data for Generative AI & Agentic AI Workshop
const generativeAiWorkshopData = {
    slug: "generative-agentic-ai",
    title: "Generative AI & Agentic AI",
    Icon: BrainCircuit, 
    iconColorClass: "icon-color-purple", // Defined in GenerativeAiWorkshopStyles.css
    intro: "Explore the fascinating world of AI that can create! This workshop delves into Generative AI (like ChatGPT, DALL-E) and the emerging concepts of Agentic AI systems that can perform tasks autonomously.",
    learningPoints: [
        "What is Artificial Intelligence, Machine Learning, and Deep Learning?",
        "Introduction to Generative AI: How it works (LLMs, Diffusion Models).",
        "Exploring popular Generative AI tools for text, image, and code generation.",
        "Understanding prompt engineering for better AI outputs.",
        "Ethical considerations and societal impact of Generative AI.",
        "Introduction to Agentic AI: concepts of AI agents performing tasks.",
        "Potential applications and future of AI."
    ],
    keyTakeaways: [
        "Understanding of what Generative and Agentic AI are and how they function at a high level.",
        "Hands-on experience with current Generative AI tools.",
    ...
    galleryImages: [
        { src: "https://placehold.co/800x600/8b5cf6/ffffff?text=AI+Brain+Concept", alt: "AI Brain Concept" },
        { src: "https://placehold.co/800x600/a78bfa/ffffff?text=Generative+Art", alt: "Generative Art Example" },
        { src: "https://placehold.co/800x600/c4b5fd/ffffff?text=AI+Chatbot+Interface", alt: "AI Chatbot Interface" },
...
export default function GenerativeAiWorkshopPage() {
    // useEffect(() => {
    //    document.body.classList.add('dark'); // Or 'light'
    //    return () => document.body.classList.remove('dark');
    // }, []);

    return <WorkshopInfoPageLayout workshopData={generativeAiWorkshopData} />;
}
